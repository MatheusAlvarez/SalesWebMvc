...
- SalesWebMvc (Pasta que armazena o projeto)
...
SalesWebMvc é um projeto criado no curso {Nome do curso}
...
- [x] Se o usuário não enviar mensagens dentro de 1 minuto o chat deve responder uma mensagem
...
![Mobile1](https://github.com/MatheusAlvarez/SalesWebMvc/blob/main/_assets/TelaInicial.png)<br>
